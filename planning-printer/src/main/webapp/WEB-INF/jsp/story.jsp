...
<div class="row" id="story-step-content">
				...
				<tbody>
					<c:forEach items="${stories}" var="story">
						<tr class="user-story-tr" data-id="${story.id}">
							...
							<td style="text-align: center"><span class="glyphicon glyphicon-pencil edit-story" data-toggle="modal" aria-hidden="true"  data-target="#popupEditStory_${story.id}"></span></td>
	...
	<div class="modal fade" id="popupEditTask" tabindex="-1"
		...
		<c:forEach items="${stories}" var="story">
	<div class="modal fade" id="popupEditStory_${story.id}" tabindex="-1"
		role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
